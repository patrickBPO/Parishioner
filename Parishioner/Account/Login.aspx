<%@ Page Title="Log in" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Login.aspx.vb" Inherits="Parishioner.Login" Async="true" %>

<%@ Register Src="~/Account/OpenAuthProviders.ascx" TagPrefix="uc" TagName="OpenAuthProviders" %>
<%@ Import Namespace="Parishioner" %>
<%@ Import Namespace="Microsoft.AspNet.Identity" %>
<%@ import Namespace="MySql.AspNet.Identity" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                   <% If (Context.User.Identity.Name.Equals("Admin")) Then %>
